...
const BoardListItem = ({title}) => {
	return (
		<li className="board-list-item" >
			<a className="board-tile" href="/detail" style={{backgroundImage: `url("https://trello-backgrounds.s3.amazonaws.com/SharedBackground/641x960/9c0a570b328ab427f18a15bfd2ffd838/photo-1568313081041-dbd174f69e3b.jpg")`}} >
